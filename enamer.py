...
parser.add_argument('-H',"--harvest",default=False,action='store_true',help="identifies if content is coming from theHarvester")
...
for name in lines:
	...
	for sobrenome in listOfSobrenomes:
		...
		if sobrenome in blacklist: continue
